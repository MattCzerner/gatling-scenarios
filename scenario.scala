...
object Walk {
  ...
  val categoryListFilterPrice = http("Category list filtering by price")
    .get("/electronics/?product_filter_form[minimalPrice]=0&product_filter_form[maximalPrice]=20000")
    .headers(headers_ajax)

  val categoryListFilterPriceBrand = http("Category list filtering by price with brand selected")
  ...
  var walk = {
    ...
    .pause(100.milliseconds)
    .exec(categoryListFilterPriceBrand)
    .pause(100.milliseconds)
    .exec(categoryListFilterParameters)
    .pause(100.milliseconds)
    .exec(categoryListFilterAllFilters)
    .pause(100.milliseconds)
    .exec(cartAdd(1))
    .pause(100.milliseconds)
    .exec(productDetail)
